<template>
    <div>
        ...
        <b-container fluid class="mt-4">
                ...
                <b-col class="text-center">
                    <b-table bordered hover :items="cart" :fields="fields">
                        ...
                        <template v-slot:cell(image)="data">
                            <b-col class="text-center">
                                <b-img style="max-width: 5rem;" :src="require('@/assets/products/product'+data.item.id+'.jpg')" fluid alt="product img"></b-img>
                            </b-col>
                        </template>
                    </b-table>
                </b-col>
            ...
            <b-modal hide-header-close no-close-on-esc no-close-backdrop ref="modal-1" centered title="Purchase Completed">
